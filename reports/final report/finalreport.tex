...
%add figure of A W product and M: Slide no 8
...
We went over each anchor word and saw that all of them accurately and uniquely represents the topic of document they belong to. For example, the anchor word 'y' {\color{orange} Complete this }
...
From given AP dataset we evaluated our algorithm. Algorithm returned anchor words such as Buenoes, Edt, Chapman, Y, bcspehealth, cdy, cycle, nikkei and heres. Once we got all Anchor words from Algorithm, we checked ourselves to see the topics that these anchors are inclined to. After self-analysis of whole ap dataset, following is our observation based on each anchor word:
